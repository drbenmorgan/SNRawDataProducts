...
namespace snfee {
  namespace data {
    ...
    void
    calo_waveform::serialize(Archive& ar_, const unsigned int /* version */)
    {
    ...
    template <class Archive>
    void
    calo_waveform_baseline::serialize(Archive& ar_,
                                      const unsigned int /* version */)
    {
      ar_& boost::serialization::make_nvp("quality_flags", quality_flags);
      ar_& boost::serialization::make_nvp("baseline_start_ns",
                                          baseline_start_ns);
      ar_& boost::serialization::make_nvp("baseline_duration_ns",
      ...
      ar_& boost::serialization::make_nvp("sigma_baseline_mV",
                                          sigma_baseline_mV);
    ...
    template <class Archive>
    void
    calo_waveform_peak::serialize(Archive& ar_,
                                  const unsigned int /* version */)
    {
      ar_& boost::serialization::make_nvp("quality_flags", quality_flags);
      ar_& boost::serialization::make_nvp("time_cell", time_cell);
      ar_& boost::serialization::make_nvp("time_head_10_percent_cell",
                                          time_head_10_percent_cell);
      ar_& boost::serialization::make_nvp("time_head_90_percent_cell",
                                          time_head_90_percent_cell);
      ar_& boost::serialization::make_nvp("time_tail_90_percent_cell",
                                          time_tail_90_percent_cell);
      ar_& boost::serialization::make_nvp("time_tail_10_percent_cell",
                                          time_tail_10_percent_cell);
      ...
      ar_& boost::serialization::make_nvp("sigma_amplitude_mV",
                                          sigma_amplitude_mV);
      ar_& boost::serialization::make_nvp("time_head_10_percent_ns",
                                          time_head_10_percent_ns);
      ar_& boost::serialization::make_nvp("time_head_90_percent_ns",
                                          time_head_90_percent_ns);
      ar_& boost::serialization::make_nvp("time_tail_90_percent_ns",
                                          time_tail_90_percent_ns);
      ar_& boost::serialization::make_nvp("time_tail_10_percent_ns",
                                          time_tail_10_percent_ns);
      return;
    }
    ...
    template <class Archive>
    void
    calo_waveform_cfd::serialize(Archive& ar_, const unsigned int /* version */)
    {
    ...
    template <class Archive>
    void
    calo_waveform_charge::serialize(Archive& ar_,
                                    const unsigned int /* version */)
    {
      ar_& boost::serialization::make_nvp("quality_flags", quality_flags);
    ...
    template <class Archive>
    void
    calo_waveform_firmware_data::serialize(Archive& ar_,
                                           const unsigned int /* version */)
    {
      ar_& boost::serialization::make_nvp("baseline_mV", baseline_mV);
    ...
    template <class Archive>
    void
    calo_waveform_info::serialize(Archive& ar_,
                                  const unsigned int /* version */)
    {
