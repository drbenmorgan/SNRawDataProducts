...
namespace snfee {
  namespace data {
    ...
    channel_id_selection::channel_id_selection() { return; }
    ...
    void
    channel_id_selection::configure(const config_type& cfg_)
    {
    ...
    void
    channel_id_selection::add_crate(const int16_t num_)
    {
    ...
    void
    channel_id_selection::add_board(const int16_t num_)
    {
    ...
    void
    channel_id_selection::add_channel(const int16_t num_)
    {
    ...
    void
    channel_id_selection::add_id(const channel_id& id_)
    {
    ...
    void
    channel_id_selection::set_reverse(const bool r_)
    {
      _reverse_ = r_;
      return;
    }
    ...
    bool
    channel_id_selection::operator()(const snfee::data::channel_id& chid_) const
    {
      bool select = true;
