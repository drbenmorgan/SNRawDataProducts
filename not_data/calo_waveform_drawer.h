...
namespace snfee {
  namespace data {
    ...
    public:
      ...
      void set_range_time(const double time_min_ns_, const double time_max_ns_);
    ...
    private:
      ...
      double _amp_min_mV_ =
        -1500.0; ///< Lower bound on signal amplitude axis (mV)
      double _amp_max_mV_ =
        +1500.0; ///< Upper bound on signal amplitude axis (mV)
