...
namespace snfee {
  namespace model {
    ...
    struct feb_constants {
      ...
      static constexpr uint16_t SAMLONG_DEFAULT_SAMPLING_FREQUENCY_MHZ =
        64 * MAIN_CLOCK_FREQUENCY_MHZ;
      ...
      // FEAST ASIC:
      static const uint16_t FEAST_CLOCK_FREQUENCY_MHZ =
        2 * MAIN_CLOCK_FREQUENCY_MHZ;
      ...
      static constexpr uint16_t CFEB_NUMBER_OF_SAMLONGS =
        CFEB_NUMBER_OF_FE_FPGA * CFEB_NUMBER_OF_SAMLONGS_PER_FE_FPGA;
      static constexpr uint16_t CFEB_NUMBER_OF_CHANNELS =
        SAMLONG_NUMBER_OF_CHANNELS * CFEB_NUMBER_OF_SAMLONGS;
      ...
      static constexpr uint16_t TFEB_NUMBER_OF_CHANNELS =
        TFEB_NUMBER_OF_FEASTS * FEAST_NUMBER_OF_CHANNELS;
