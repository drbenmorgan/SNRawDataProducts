...
namespace snfee {
  namespace data {
    ...
    //! \brief Abstract interface for raw hits of any type with have a unique identifier/number and a trigger ID
    class raw_record_interface
