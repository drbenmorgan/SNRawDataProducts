  ...
  namespace data {
    ...
    bool trigger_record::is_complete() const
    {
      ...
      if (_trigger_mode_ == TRIGGER_MODE_APE or
        ...
        if (_progenitor_trigger_id_ <= TRIGGER_MODE_INVALID) return false;
      }
      return true;
    }
                                    ...
                                    const boost::property_tree::ptree & options_) const
    {
      ...
      out_ << popts.indent << tag
           << "Progenitor trigger ID : " << _progenitor_trigger_id_ << std::endl;
    ...
    void trigger_record::set_hit_num(const int32_t hit_num_)
    {
      _hit_num_ = hit_num_;
      return;
    }

    int32_t trigger_record::get_hit_num() const
    {
      return _hit_num_;
    }
    ...
    void trigger_record::set_progenitor_trigger_id(const int32_t ptid_)
    {
      DT_THROW_IF(ptid_ > MAX_TRIGGER_ID, std::logic_error,
    ...
    bool trigger_record::has_progenitor_trigger_id() const
    {
      return _progenitor_trigger_id_ != INVALID_TRIGGER_ID;
    }

    int32_t trigger_record::get_progenitor_trigger_id() const
    {
      return _progenitor_trigger_id_;
    }

    void trigger_record::set_l2_clocktick_1600ns(const uint32_t l2_clocktick_1600ns_)
    {
    ...
    timestamp trigger_record::convert_timestamp() const
    {
      timestamp ts;
    ...
    void trigger_record::make(const int32_t trigger_hit_num_,
                              const int32_t trigger_id_,
                              const trigger_mode_type trigger_mode_)
    {
      DT_THROW_IF(trigger_hit_num_ <= INVALID_NUMBER, std::logic_error, "Invalid hit number [" << trigger_hit_num_ << "]!");
      _hit_num_ = trigger_hit_num_;    
      DT_THROW_IF(trigger_id_ <= INVALID_TRIGGER_ID, std::logic_error, "Invalid trigger ID [" << trigger_id_ << "]!");
